...
import { requestVerificationLink, signIn, signInWithGoogle, signUp, verifyAccount } from '../services/auth.service';
...
export const googleSignInController = asyncHandler(async function (req: Request, res: Response) {
